@extends('admin.layouts.main', ['title' => 'Edit Event'])
                ...
                <form action="{{ route('events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                            name="slug" value="{{ old('slug', $event->slug) }}" readonly>
                        @error('slug')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="detail" name="detail" class="form-control @error('detail') is-invalid @enderror" required>{{ old('detail', $event->detail) }}</textarea>
                        @error('detail')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('lat') is-invalid @enderror" id="lat"
                            name="lat" value="{{ old('lat', $event->lat) }}" required>
                        @error('lat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('long') is-invalid @enderror" id="long"
                            name="long" value="{{ old('long', $event->long) }}" required>
                        @error('long')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control @error('poster') is-invalid @enderror" id="poster-url"
                                name="poster" value="{{ old('poster', $event->poster) }}" readonly>
                    ...
                    <!-- Preview Poster -->
                    <div class="mb-3" id="poster-preview-container" style="{{ $event->poster ? '' : 'display: none;' }}">
                        <label for="poster-preview" class="form-label">Preview Poster</label>
                        <img id="poster-preview" src="{{ old('poster', $event->poster) }}" alt="Preview Poster"
