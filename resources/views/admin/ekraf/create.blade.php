@extends('admin.layouts.main', ['title' => 'Tambah Ekraf'])

@section('main')
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Tambah Ekraf Baru</h5>

                <form action="{{ route('ekrafs.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3" id="logo-preview-container" style="display: none;">
                        ...
                        <img id="logo-preview" src="#" alt="Preview Logo" class="img-thumbnail"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('social_media') is-invalid @enderror"
                                name="social_media" value="{{ old('social_media') }}">
                            @error('social_media')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
