@extends('admin.layouts.main', ['title' => 'Edit Destinasi'])
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('destinations.update', $destination->slug) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                            name="slug" value="{{ old('slug', $destination->slug) }}" readonly>
                        @error('slug')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror">{{ old('description', $destination->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('lat') is-invalid @enderror" id="lat"
                            name="lat" value="{{ old('lat', $destination->lat) }}" required>
                        @error('lat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('long') is-invalid @enderror" id="long"
                            name="long" value="{{ old('long', $destination->long) }}" required>
                        @error('long')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control @error('image') is-invalid @enderror" id="image-url"
                                name="image" value="{{ old('image', $destination->image) }}" readonly>
                    ...
                    <div class="mb-3" id="image-preview-container"
                        style="display: {{ $destination->image ? 'block' : 'none' }};">
                        <label for="image-preview" class="form-label">Preview Gambar</label>
                        <img id="image-preview" src="{{ $destination->image ? asset($destination->image) : '#' }}"
                            alt="Preview Gambar" class="img-thumbnail" style="max-width: 100%; height: auto;">
                    </div>
